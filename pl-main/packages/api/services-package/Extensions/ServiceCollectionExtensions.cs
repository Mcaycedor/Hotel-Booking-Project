...
namespace Gen.Platform.Services
{
  ...
  public static class ServiceCollectionExtensions
  {
    ...
    /// <summary>
    /// Configure GEN Platform services
    /// </summary>
    public static IServiceCollection AddGenPlatformServices(this IServiceCollection services, string apiTitle, string[] versions)
    {
