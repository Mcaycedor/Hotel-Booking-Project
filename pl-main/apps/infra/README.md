...
Both stacks are provided by the `@gigisa/infra-components` library, which implements reusable infrastructure patterns for the Starter App.

## Features

The infra app leverages the following default features from the gigisa infra components library:
...
| ------------------------- | -------- | ----------------------------------------------------------- |
| `@gigisa/infra-components` | Library  | Starter App infrastructure components (WebStack, ApiStack)  |
| `@gen/infra-components`   | Package  | GEN Platform shared infrastructure constructs and utilities |
